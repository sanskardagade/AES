...
export default function Security() {
  ...
  return (
    <div className="min-h-screen bg-[#b0cece] relative overflow-hidden">
      ...
      >
        {/* Hero Section */}
        <h1 className="text-5xl md:text-6xl font-extrabold text-[#0c2543] mb-6">Security at AES Platform</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {securityFeatures.map((feature, index) => (
            <motion.div
              ...
              className="bg-white/90 backdrop-blur-md rounded-2xl p-6 border border-[#0c2543]/20 shadow-md transition"
            >
