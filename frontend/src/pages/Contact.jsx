        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 text-left">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">support@aesplatform.com</p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
            <div className="p-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">123 AES Street, Learning City, World</p>
            </div>
          </div>
        </div>

        {/* Contact Form */}
        <form onSubmit={handleSubmit} className="bg-gray-800/80 backdrop-blur-md p-8 rounded-2xl border border-white/20 shadow-md text-left">
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full mt-2 px-4 py-3 bg-gray-900 text-white border border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
            />
          </div>
          <div className="mb-4">
