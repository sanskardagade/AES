...
export default function Signup() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900 relative overflow-hidden">
      ...
      >
        <h2 className="text-3xl font-extrabold text-white mb-6">Create Account ✨</h2>
        <p className="text-gray-300 mb-6 text-sm">Sign up to start your AES Platform journey</p>
