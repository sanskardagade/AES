...
export default function Signup() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white relative overflow-hidden">
      ...
      >
        <h2 className="text-3xl font-extrabold text-blue-zodiac mb-6">Create Account ✨</h2>
        <p className="text-blue-zodiac/70 mb-6 text-sm">Sign up to start your AES Platform journey</p>
        ...
        <form onSubmit={handleSignup}>
          ...
          <div className="relative mb-4">
            <User className="absolute left-3 top-3 text-blue-zodiac/40" size={20} />
            <input
              type="text"
        ...
        <p className="text-sm text-blue-zodiac/70 mt-6">
          ...
          <a href="/login" className="text-blue-chill font-semibold hover:underline">
            Login
          </a>
        </p>
      </motion.div>
