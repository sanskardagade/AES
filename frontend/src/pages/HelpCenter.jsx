...
export default function HelpCenter() {
  ...
  return (
    <div className="min-h-screen bg-white text-blue-zodiac relative overflow-hidden">
      ...
      >
        {/* Hero Section */}
        <h1 className="text-5xl md:text-6xl font-extrabold text-blue-zodiac mb-6">Help Center</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {helpTopics.map((topic, index) => (
            <motion.div
              ...
              className="bg-white/80 backdrop-blur-md rounded-2xl p-6 border border-jet-stream/50 shadow-md transition"
            >
              <div className="w-16 h-16 flex items-center justify-center bg-blue-chill rounded-2xl mb-4 mx-auto">
                <topic.icon className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-blue-zodiac mb-2">{topic.title}</h3>
              <p className="text-blue-zodiac/70 text-sm">{topic.desc}</p>
            </motion.div>
          ))}
        </div>
        ...
        <div className="mt-16">
          <motion.div
            ...
            className="inline-block bg-blue-chill text-white py-4 px-10 rounded-2xl font-semibold shadow-2xl cursor-pointer hover:bg-blue-zodiac transition"
